...
public class PartnerReservationEntity extends ReservationEntity implements Serializable {
    ...
    public PartnerReservationEntity(Date checkInDate, Date checkOutDate) {
        super(checkInDate, checkOutDate);
    }

    public PartnerReservationEntity(Date checkInDate, Date checkOutDate, BigDecimal pricePaidForRLE) {
